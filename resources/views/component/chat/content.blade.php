...
<div class="text-white pt-2 px-7 h-full">
    <ul id="chat-scroll" class="p-0 m-0 overflow-y-scroll h-full  ">
            ...
            @foreach ($chat as $message)
                ...
                @else
                    <li class="w-full py-1">
                        ...
                        <div class="inline-block bg-gray-600 p-2 rounded-lg" style="max-width : 50%">
                            <div class="w-full flex flex-col">
                                <span>{{ $message ->text }}</span>
                                <div class="w-full flex justify-end  items-center space-x-2" style="font-size : 11px">
                                    <span>7:20 PM</span>
        ...
        <li class="w-full py-1">
            ...
            <div class="inline-block bg-gray-600 p-2 rounded-lg" style="max-width : 50%">
                <div class="w-full flex flex-col">
                    <span>Chat with {{ $_SESSION['chatWith'] }}</span>
                    <div class="w-full flex justify-end  items-center space-x-2" style="font-size : 11px">
                        <span>7:20 PM</span>
...
<input type="hidden"  id="chat-input-hidden">